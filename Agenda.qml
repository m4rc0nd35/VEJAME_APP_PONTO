...
Page {
    ...
    ListView {
        anchors.fill: parent
        model: agendamento.listModelAgenda
        spacing: 3
        delegate: Component {
            Rectangle {
                id: idRow
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: agendamento.refreshAgenda()
        }
    }
    ...
    Popup {
        ...
        Rectangle {
            ...
            Button {
                ...
                onClicked: {
                    popupButons.close()
                    agendamento.agendaState(id_agenda, 1)
                }
            ...
            Button {
                ...
                onClicked: {
                    popupButons.close()
                    agendamento.agendaState(id_agenda, 3)
                }
                background: Rectangle {
                    implicitWidth: cancelarBt.width
                    implicitHeight: cancelarBt.height
                    opacity: enabled ? 1 : 0.3
                    border.color: "#94999E"
                    border.width: 1
                    radius: 2
